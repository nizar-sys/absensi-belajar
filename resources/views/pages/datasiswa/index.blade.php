                        ...
                        @can('admin')
                            <div class="card-header">
                                ...
                                <a href="{{ route('datasiswa.create', $role) }}"
                                    ...
                                    data-bs-placement="right" title="Tambah Data Siswa">
                                        ...
                                        <tbody>
                                            @foreach ($siswa as $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $item->ortu->name ?? 'belum diset' }}</td>
                                                    <td>{{ $item->name }}</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="button" class="btn btn-success pb-1 pt-0 px-2"
                                                            ...
                                                            data-bs-placement="top" title="Detail Data Siswa">
                                                        ...
                                                        <div class="modal fade" id="modalShow/{{ $item->id }}"
                                                            ...
                                                            <div class="modal-dialog modal-md modal-dialog-scrollable">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title fw-bold poppins"
                                                                            id="exampleModalLabel">Detail Siswa
                                                                        </h5>
                                                                        <button type="button" class="btn-close"
                                                                            data-bs-dismiss="modal"
                                                                            aria-label="Close"></button>
