...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="row mb-0">
                <div class="col-sm-6">
                    <h4 class="fw-bold poppins m-0">Data Orangtua</h4>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('dataortu.create', $role) }}"
                                class="btn btn-sm float-left btn-primary btn-icon-split" data-bs-toggle="tooltip"
                                data-bs-placement="right" title="Tambah Data Orangtua">
                                            ...
                                            @foreach ($ortu as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('dataortu.edit', ['dataortu' => $item->id, 'role' => $role]) }}"
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        Orangtua: <p class="text-primary fw-bold">
                                                                            {{ $item->name }}
                                                                        </p>
                                                                        Data tersebut tidak dapat dihapus. Karena sudah
                                                                        memiliki relasi!
                                                                    </div>
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('dataortu.destroy', ['dataortu' => $item->id, 'role' => $role]) }}"
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title fw-semibold poppins"
                                                                            id="exampleModalLabel">Detail Orangtua
                                                                        </h5>
                                                                        <button type="button" class="btn-close"
                                                                            data-bs-dismiss="modal"
                                                                            aria-label="Close"></button>
                                                                    ...
                                                                    <div class="modal-body pe-0">
                                                                        <div class="table-responsive row col-12">
                                                                            <table>
                                                                                ...
                                                                                <tr class="border-bottom">
                                                                                    <td class="fw-bold">Status Orangtua
                                                                                    </td>
                                                                                    <td style="width: 1px;">:</td>
                                                                                    <td>
                                                                                        @if ($item->user->is_aktif == '1')
