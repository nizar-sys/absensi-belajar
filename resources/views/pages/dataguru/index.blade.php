...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
          ...
          <div class="row mb-0">
            <div class="col-sm-6">
                <h4 class="fw-bold poppins m-0">Data Guru</h4>
            </div>
            <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('dataguru.create', $role) }}"
                                class="btn btn-sm float-left btn-primary btn-icon-split" data-bs-toggle="tooltip" data-bs-placement="right" title="Tambah Data Guru">
                                            ...
                                            @foreach ($guru as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('dataguru.edit', ['dataguru' => $item->id, 'role' => $role]) }}"
                                                        ...
                                                        @if (count($kelas->where('guru_id', $item->id)) > 0)
                                                        <button type="button"
                                                        ...
                                                        @elseif (count($pembelajaran->where('guru_id', $item->id)) > 0)
                                                        <button type="button"
                                                            class=" btn btn-danger pb-1 pt-0 px-2 d-inline"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#modalGagalDelete/{{ $item->id }}">
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('dataguru.destroy', ['dataguru' => $item->id, 'role' => $role]) }}"
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title fw-semibold poppins"
                                                                            id="exampleModalLabel">Detail Guru
                                                                        </h5>
                                                                        <button type="button" class="btn-close"
                                                                            data-bs-dismiss="modal"
                                                                            aria-label="Close"></button>
                                                                    ...
                                                                    <div class="modal-footer">
                                                                      <a href="{{ route('dataguru.edit', ['dataguru' => $item->id, 'role' => $role]) }}" type="button"
