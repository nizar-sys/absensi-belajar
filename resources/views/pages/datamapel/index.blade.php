...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
          ...
          <div class="row mb-0">
            <div class="col-sm-6">
                <h4 class="fw-bold poppins m-0">Data Mata Pelajaran</h4>
            </div>
            <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('datamapel.create') }}"
                                class="btn btn-sm float-left btn-primary btn-icon-split" data-bs-toggle="tooltip" data-bs-placement="right" title="Tambah Data Mapel">
                                  ...
                                  <tbody>
                                      @foreach ($mapel as $item)
                                          <tr>
                                              ...
                                              <td>
                                                  <a href="{{ route('datamapel.show', $item->id) }}"
                                                  ...
                                                  <a href="{{ route('datamapel.edit', $item->id) }}" type="button"
                                                ...
                                                @if ($pembelajaran->where('mapel_id', $item->id)->count() < 1)
                                                  <button type="button"
                                                      ...
                                                      <div class="modal-dialog">
                                                          <div class="modal-content">
                                                              ...
                                                              <div class="modal-body">
                                                                  Mapel: <p class="text-primary fw-bold">
                                                                    {{ $item->name }}
                                                                  </p>
                                                              ...
                                                              <div class="modal-footer">
                                                                  ...
                                                                  <form
                                                                      action="{{ route('datamapel.destroy', $item->id) }}"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                               ...
                                                               Data tersebut tidak dapat dihapus! Karena terdapat beberapa pembelajaran pada <b>Mapel - {{ $item->name }}</b>
                                                            </div>
                                                            <div class="modal-footer">
