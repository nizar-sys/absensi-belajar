...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
          ...
          <div class="row mb-0">
            <div class="col-sm-6">
                <h4 class="fw-bold poppins m-0">Data Pembelajaran @can('guru') Saya @endcan</h4>
            </div>
            <div class="col-sm-6">
                                            ...
                                            @foreach ($pembelajaran as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                      ...
                                                      @can('admin', )
                                                        <a href="{{ route('datapembelajaran.edit', ['datapembelajaran' => $item->id, 'role' => $role]) }}"
                                                            type="button" class=" btn btn-primary pb-1 pt-0 px-2">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                                height="16" fill="currentColor"
                                                        ...
                                                        @if ($pertemuan->where('pembelajaran_id', $item->id)->count() < 1)
                                                            <button type="button"
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        Data Pembelajaran: <p class="text-primary fw-bold">
                                                                             {{ $item->mapel->singkatan }} -
                                                                            {{ $item->kelas->name }}
                                                                        </p>
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('datapembelajaran.destroy', ['datapembelajaran' => $item->id, 'role' => $role]) }}"
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        beberapa siswa di Pembelajaran<b>
                                                                            {{ $item->mapel->singkatan }} -
                                                                            {{ $item->kelas->name }}</b>
                                                                    </div>
                                                                    <div class="modal-footer">
